...
page = Blueprint('view8', __name__)
client = MongoClient('localhost', 27017)
db = client['diva-proj']
mycol5=db['authors_ahmed']
...
def authors_ant():
    author_works = list(mycol5.find())
    author_works = author_works[0]['Ahmed Elgammal']
    g2=nx.Graph()
    author_name='Ahmed Elgammal'
...
@page.route("/view8")
def view8_index():
    return redirect(url_for('static', filename='view8/index.html'))


@page.route("/view8/authorsant")
def get_author_data5():
    data = authors_ant()
    #print(data)
    return jsonify(data)