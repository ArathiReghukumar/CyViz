...
page = Blueprint('view6', __name__)
client = MongoClient('localhost', 27017)
db = client['diva-proj']
mycol3=db['authors_bad']
...
def author_bad():
    author_works = list(mycol3.find())
    author_works = author_works[0]['Badri Nath']
    g2=nx.Graph()
    author_name='Badri Nath'
...
@page.route("/view6")
def view6_index():
    return redirect(url_for('static', filename='view6/index.html'))


@page.route("/view6/authorsbadri")
def get_author_data3():
    data = author_bad()
    #print(data)
    return jsonify(data)